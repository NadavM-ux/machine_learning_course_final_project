...
> The project now trains **2 tasks** (`target_population`, `person_vs_organization`), so the
> experiment sweep is **864 rows**, not 1,296 (3 × 2 × 9 × 6 × 2 × 2 → 2 × 2 × 9 × 6 × 2 × 2).
> Ignore `locals_vs_diaspora` and the §11 "high-accuracy lie" example that uses it; the
> concept (watch AUC, not accuracy) still applies to the remaining tasks.
